...
const DetailsNutrition: FC<DetailsNutritionProps> = memo(
  ({ dataImage, data }) => {
    return (
      <div className="max-laptop-s:flex-col-reverse max-laptop-s:items-center max-laptop-s:gap-y-15 flex justify-between gap-x-10">
        <img
          ...
          alt=""
        />
        <div className="bg-custom-blue min-laptop-s:max-w-120 flex w-full flex-col justify-between gap-y-10 rounded-4xl p-8">
