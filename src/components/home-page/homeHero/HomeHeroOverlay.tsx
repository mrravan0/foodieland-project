...
const HomeHeroOverlay: FC<HomeHeroOverlayProps> = ({ data, info }) => {
  return (
    <div className="bg-custom-blue flex justify-between rounded-4xl max-laptop-s:items-center">
      <div className="flex flex-col justify-between p-12.5">
        <div className="flex flex-col gap-y-7.5">
          ...
          <div className="flex flex-col gap-y-6.25">
            <h1 className="text-custom-5xl font-semibold">{data.title}</h1>
        ...
        <div className="flex items-center justify-between max-tablet:flex-col">
      ...
      <img
        className="cursor-pointer rounded-4xl duration-300 hover:scale-105 max-laptop-s:size-100"
